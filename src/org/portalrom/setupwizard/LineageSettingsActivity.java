...
public class PortalRomSettingsActivity extends BaseSetupWizardActivity {

    public static final String TAG = PortalRomSettingsActivity.class.getSimpleName();

    public static final String PRIVACY_POLICY_URI = "https://portalrom.org/legal";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String metricsHelpImprovePortalRom =
                getString(R.string.services_help_improve_cm, os_name);
        String metricsSummary = getString(R.string.services_metrics_label,
                metricsHelpImprovePortalRom, os_name, os_name);
        final SpannableStringBuilder metricsSpan = new SpannableStringBuilder(metricsSummary);
        metricsSpan.setSpan(new android.text.style.StyleSpan(android.graphics.Typeface.BOLD),
                0, metricsHelpImprovePortalRom.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        if (mSupportsKeyDisabler) {
            mNavKeys.setChecked(PortalRomSettings.System.getIntForUser(getContentResolver(),
                    PortalRomSettings.System.FORCE_SHOW_NAVBAR, 0, UserHandle.USER_CURRENT) != 0);
        } else {
    ...
    protected int getLayoutResId() {
        return R.layout.setup_portalrom_settings;
    }
    ...
    private void updateDisableNavkeysOption() {
        if (mSupportsKeyDisabler) {
            final Bundle myPageBundle = mSetupWizardApp.getSettingsBundle();
            boolean enabled = PortalRomSettings.System.getIntForUser(getContentResolver(),
                    PortalRomSettings.System.FORCE_SHOW_NAVBAR, 0, UserHandle.USER_CURRENT) != 0;
    ...
    private static boolean isKeyDisablerSupported(Context context) {
        ...
        return hardware.isSupported(PortalRomHardwareManager.FEATURE_KEY_DISABLE);
    }
}
