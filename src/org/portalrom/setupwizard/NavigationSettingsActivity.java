...
import static org.portalrom.internal.util.DeviceKeysConstants.KEY_MASK_APP_SWITCH;
...
public class NavigationSettingsActivity extends BaseSetupWizardActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int deviceKeys = getResources().getInteger(
                org.portalrom.platform.internal.R.integer.config_deviceHardwareKeys);
    ...
    protected void onNextPressed() {
        ...
        PortalRomSettings.System.putIntForUser(getContentResolver(),
                PortalRomSettings.System.NAVIGATION_BAR_HINT, hideHint ? 0 : 1,
