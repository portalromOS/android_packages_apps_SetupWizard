...
import static org.portalrom.setupwizard.Manifest.permission.FINISH_SETUP;
import static org.portalrom.setupwizard.SetupWizardApp.ACTION_SETUP_COMPLETE;
import static org.portalrom.setupwizard.SetupWizardApp.DISABLE_NAV_KEYS;
import static org.portalrom.setupwizard.SetupWizardApp.ENABLE_RECOVERY_UPDATE;
import static org.portalrom.setupwizard.SetupWizardApp.KEY_SEND_METRICS;
import static org.portalrom.setupwizard.SetupWizardApp.LOGV;
import static org.portalrom.setupwizard.SetupWizardApp.NAVIGATION_OPTION_KEY;
import static org.portalrom.setupwizard.SetupWizardApp.UPDATE_RECOVERY_PROP;
...
public class FinishActivity extends BaseSetupWizardActivity {
    ...
    private static void handleEnableMetrics(SetupWizardApp setupWizardApp) {
        ...
        if (privacyData != null
            ...
            PortalRomSettings.Secure.putInt(setupWizardApp.getContentResolver(),
    ...
    private static void writeDisableNavkeysOption(Context context, boolean enabled) {
        ...
        final boolean virtualKeysEnabled = PortalRomSettings.System.getIntForUser(
                context.getContentResolver(), PortalRomSettings.System.FORCE_SHOW_NAVBAR, 0,
                UserHandle.USER_CURRENT) != 0;
        if (enabled != virtualKeysEnabled) {
            PortalRomSettings.System.putIntForUser(context.getContentResolver(),
                    PortalRomSettings.System.FORCE_SHOW_NAVBAR, enabled ? 1 : 0,
