...
adb shell pm enable org.portalrom.setupwizard/org.portalrom.setupwizard.SetupWizardExitActivity || true
if [[ ! -z "$has_google_suw" ]]
then
    wait ${!}
...
sleep 1
adb shell am start org.portalrom.setupwizard/org.portalrom.setupwizard.SetupWizardExitActivity || true
if [[ ! -z "$has_google_suw" ]]
then
    wait ${!}
    sleep 1
